...
cd /Users/ssbb/Sources/phoenix3.1/ext/wxWidgets/include              # go to wx include folder
...
wx_top_builddir="/Users/ssbb/Sources/phoenix3.1"
top_srcdir="/Users/ssbb/Sources/phoenix3.1/ext/wxWidgets"
flags="-D_FILE_OFFSET_BITS=64 -I${wx_top_builddir}/lib/wx/include/osx_cocoa-unicode-3.1 -I${top_srcdir}/include -DWX_PRECOMP -O2 -fno-common -fvisibility=hidden -fvisibility-inlines-hidden"
...
flags="-I . -I /Users/ssbb/Sources/phoenix3.1/ext/wxWidgets/include $flags -D__WXDEBUG__ -D__WXOSX_COCOA__ -DWXBUILDING $allheaders"
